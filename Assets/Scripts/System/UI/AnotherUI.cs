...
{
    public class AnotherUI : MonoBehaviour //UI 관리자.
    {
        ...
        private AnotherDeck deck;   //플레이어에게 들어간 CardSlots 스트립트, SetPlr에서 위의 Plr와 함께 설정
        ...
        {   //이 스크립트의 Plr에 플레이어를 배정해줌, Dungeon에서 단 1번 실행됨
            this.Plr = p;
